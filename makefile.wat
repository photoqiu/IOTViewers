...
mainUI_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) $(__THREADSFLAG_5) &
...
clean : .SYMBOLIC 
	...
	-if exist $(OBJS)\mainUI.exe del $(OBJS)\mainUI.exe

$(OBJS)\mainUI.exe :  $(mainUI_OBJECTS) $(OBJS)\mainUI_sample.res
	@%create $(OBJS)\mainUI.lbc
	@%append $(OBJS)\mainUI.lbc option quiet
	@%append $(OBJS)\mainUI.lbc name $^@
	@%append $(OBJS)\mainUI.lbc option caseexact
	@%append $(OBJS)\mainUI.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
	@for %i in ($(mainUI_OBJECTS)) do @%append $(OBJS)\mainUI.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_SCINTILLA_IF_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)   wxzlib$(WXDEBUGFLAG).lib wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE)  $(__CAIRO_LIB_p) kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib wininet.lib) do @%append $(OBJS)\mainUI.lbc library %i
	@%append $(OBJS)\mainUI.lbc option resource=$(OBJS)\mainUI_sample.res
	@for %i in () do @%append $(OBJS)\mainUI.lbc option stack=%i
	wlink @$(OBJS)\mainUI.lbc

$(OBJS)\mainUI_sample.res :  .AUTODEPEND .\..\..\samples\sample.rc
...
$(OBJS)\mainUI_mainUI.obj :  .AUTODEPEND .\mainUI.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(mainUI_CXXFLAGS) $<
